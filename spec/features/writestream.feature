Feature: Write a data Stream
  ...
  Scenario:
    ...
    When  I define "127.0.0.1" and the port "4567" and the integer is 30
    Then I hear a sound

    Given I want to send an float
    When  I define "127.0.0.1" and the port "4567" and the float is 30.0
    Then I hear a sound
